...
from tools.utils import load_pretrained_weights
...
def main():
    ...
    if args.distributed:
        ...
        torch.distributed.init_process_group(backend='nccl', init_method='env://')  # 这样会卡死
    ...
    model = create_model(
        ...
        img_size=(None if 'resnet50' in args.model else args.img_size))
